...
options = RequestOptions(site_url + "/sites/" + site_site + "/_api/web/GetFolderByServerRelativeUrl('/sites/" + sourceSite + "/" + sourcePath + "')/moveto(newurl='/sites/" + sourceSite + "/" + destinationPath + "')")
