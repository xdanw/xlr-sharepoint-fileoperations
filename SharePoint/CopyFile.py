...
options = RequestOptions(site_url + "/sites/" + site_site + "/_api/web/GetFileByServerRelativeUrl('/sites/" + sourceSite + "/" + sourcePath + "')/copyto(newurl='/sites/"  + sourceSite + "/" + destinationPath + "',flags=1)")
